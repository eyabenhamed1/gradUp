...
$configPath = 'C:/xampp/htdocs/projettt/projettt/ProjetWeb2A/Config.php';
...
$participantsQuery = $pdo->prepare("
    ...
    INNER JOIN etudiant e ON p.id_etudiant = e.id_etudiant
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm"><?= htmlspecialchars($part['prenom'] . ' ' . $part['nom']) ?></h6>
                                                            <p class="text-xs text-secondary mb-0">ID: <?= $part['id_etudiant'] ?></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
