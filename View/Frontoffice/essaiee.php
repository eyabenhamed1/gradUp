...
<body>
    ...
    <div class="order-link-container">
        <a href="macommande.php" class="order-link">
    ...
    <div class="filters-section">
        <!-- Boutons de catégorie au centre -->
        <div class="category-filter">
            <a href="?category=tous" class="filter-btn <?= $selectedCategory === 'tous' ? 'active' : '' ?>">
                <i class="fas fa-th-large"></i> Tous
            </a>
            <a href="?category=vetement" class="filter-btn <?= $selectedCategory === 'vetement' ? 'active' : '' ?>">
                <i class="fas fa-tshirt"></i> Vêtements
            </a>
            <a href="?category=fourniture" class="filter-btn <?= $selectedCategory === 'fourniture' ? 'active' : '' ?>">
                <i class="fas fa-pencil-alt"></i> Fournitures
            </a>
            <a href="?category=informatique" class="filter-btn <?= $selectedCategory === 'informatique' ? 'active' : '' ?>">
        ...
        <div class="footer-container">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li class="footer-link"><a href="evenements.php">évenement</a></li>
