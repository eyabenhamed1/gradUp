...
//////tebaa evenement    
    // Ajoutez cette méthode depuis EtudiantController
    public function getUtilisateurById($id) {
        if (!is_numeric($id)) {
            throw new InvalidArgumentException('ID doit être numérique');
        }
        
        $user = new Utilisateur("", "", "", "");
        return $user->getUtilisateurById($id);
    }

    // Exemple d'ajout d'une méthode spécifique pour les étudiants
    public function getEtudiants() {
        $user = new Utilisateur("", "", "", "");
        return $user->getEtudiants();
    }
?>
